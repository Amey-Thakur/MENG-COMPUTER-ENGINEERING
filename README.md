...
[❖ Author](#author) &nbsp;·&nbsp; [ⓘ Overview](#overview) &nbsp;·&nbsp; [◎ Motivation](#motivation) &nbsp;·&nbsp; [☰ Curriculum](#course-catalog) &nbsp;·&nbsp; [★ Projects](#computer-engineering--applied-research-projects) &nbsp;·&nbsp; [◈ Experiential Learning](#experiential-learning--community-service) &nbsp;·&nbsp; [◬ Support](#student-support-resources) &nbsp;·&nbsp; [☷ Usage Guidelines](#usage-guidelines) &nbsp;·&nbsp; [© License](#license) &nbsp;·&nbsp; [⌬ About](#about-this-repository) &nbsp;·&nbsp; [✦ Acknowledgments](#acknowledgments)
...
🧠 **Computational Intelligence Algorithms** · *Computational Intelligence (Semester IV)*
  - [x] [Convolutional Neural Network (CNN)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Convolutional_Neural_Network.m)
  ...
  - [x] [Radial Basis Function Network (RBFN)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Radial_Basis_Function_Network.m)
  - [x] [Radial Basis Function Optimization (RBFO)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Radial_Basis_Function_Optimization.m)
  - [x] [Learning Vector Quantization (LVQ)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Learning_Vector_Quantization.m)
  - [x] [Bidirectional Associative Memory (BAM)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Bidirectional_Associative_Memory.m)
  - [x] [Generalized Hopfield Network (GHN)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Generalized_Hopfield_Step_Function.m)
  - [x] [Fuzzy Logic & Reasoning (FLR)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Fuzzy_Logic_and_Reasoning.m)
  - [x] [Fuzzy Reasoning System (FRS)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Fuzzy_Reasoning_System.m)
  - [x] [Fuzzy Set Theory (FST)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Fuzzy_Set_Theory.m)
  - [x] [Fuzzy Set Operations (FSO)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Fuzzy_Set_Theory_Operations.m)
  - [x] [Genetic Algorithm Optimization (GAO)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Genetic_Algorithm_Optimization.m)
  - [x] [Genetic Algorithm Implementation (GAI)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Genetic_Algorithm_Implementation.m)
  - [x] [Genetic Algorithm Variant I (GAV-I)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Genetic_Algorithm_Variant_I.m)
  - [x] [Genetic Algorithm Variant II (GAV-II)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Genetic_Algorithm_Variant_II.m)
  - [x] [Binary to Decimal Conversion (B2D)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Binary_to_Decimal_Conversion.m)
  - [x] [Decimal to Binary Conversion (D2B)](https://github.com/Amey-Thakur/COMPUTATIONAL-INTELLIGENCE/blob/main/MATLAB/Decimal_to_Binary_Conversion.m)

📊 **Strategic Project Management Case Studies** · *Engineering Project Management (Semester II)*
  - [x] [Comparative Evaluation of Project Management Software](https://github.com/Amey-Thakur/ENGINEERING-PROJECT-MANAGEMENT/blob/main/Assignments/EPM%20Assignment%201/A%20Comparative%20Evaluation%20of%20Project%20Management%20Software%20for%20Engineering%20Projects%20%5BAmey%20Thakur%20-%20110107589%5D.pdf)
  - [x] [Strategic Implementation Analysis: Global Green Books Case Study](https://github.com/Amey-Thakur/ENGINEERING-PROJECT-MANAGEMENT/blob/main/Assignments/EPM%20Assignment%202/Driving%20Success%20through%20Project%20Management%20Implementation%20-%20A%20Case%20Study%20Analysis%20of%20Global%20Green%20Books%20Publishing.pdf)
  - [x] [E-KYC Platform Implementation & Agile Transformation](https://github.com/Amey-Thakur/ENGINEERING-PROJECT-MANAGEMENT/blob/main/Assignments/EPM%20Assignment%203/EPM%20Assignment%203%20-%20Case%20study%20and%20case%20study%20reviews.pdf)
